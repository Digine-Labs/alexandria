...
fn pow2_test() {
    ...
    assert(pow2(63) == 0x8000000000000000, 'assertion failed');
    assert(pow2(127) == 0x80000000000000000000000000000000, 'assertion failed');
}
...
fn pow2_u256_test() {
    ...
    assert(pow2_u256(128) == 340282366920938463463374607431768211456, 'assertion failed');
    assert(
        pow2_u256(
            255,
...
fn pow10_test() {
    ...
    assert(pow10(18) == 1000000000000000000, 'assertion failed');
    assert(pow10(37) == 10000000000000000000000000000000000000_u128, 'assertion failed');
}
...
fn pow10_u256_test() {
    ...
    assert(pow10_u256(38) == 100000000000000000000000000000000000000_u256, 'assertion failed');
    assert(
        pow10_u256(
            76,
