...
fn test_append_u16() {
    ...
    let expected: ByteArray = test_byte_array_8();
    assert(ba == expected, 'values should match');
}
...
fn test_append_u16_arr() {
    ...
    ba.append_u16(0x0506_u16);
    ba.append_u16(0x0708_u16);
    let expected: Array<u8> = test_array_8();
    assert(ba == expected, 'values should match');
}
...
fn test_append_u64() {
    ...
    let expected: ByteArray = test_byte_array_16();
    assert(ba == expected, 'values should match');
}
...
fn test_append_u64_arr() {
    ...
    ba.append_u64(0x0102030405060708_u64);
    ba.append_u64(0x090a0b0c0d0e0f10_u64);
    let expected: Array<u8> = test_array_16();
    assert(ba == expected, 'values should match');
}
...
fn test_append_u128() {
    ...
    let expected: ByteArray = test_byte_array_32();
    assert(ba == expected, 'values should match');
}
...
fn test_append_u128_arr() {
    ...
    ba.append_u128(0x0102030405060708090a0b0c0d0e0f10_u128);
    ba.append_u128(0x1112131415161718191a1b1c1d1e1f20_u128);
    let expected: Array<u8> = test_array_32();
    assert(ba == expected, 'values should match');
}
...
fn test_append_u512() {
    ...
    let expected: ByteArray = test_byte_array_64();
    assert(ba == expected, 'values should match');
}
...
fn test_append_u512_arr() {
    ...
    let mut ba: Array<u8> = array![];
    ba.append_u512(test64);
    let expected: Array<u8> = test_array_64();
    assert(ba == expected, 'values should match');
}
...
fn test_append_i16() {
    ...
    let expected: ByteArray = test_byte_array_8();
    assert(ba1 == expected, 'values should match');
}
...
fn test_append_i16_neg() {
    ...
    let expected: ByteArray = test_byte_array_16_neg();
    assert(ba1 == expected, 'values should match');
}
...
fn test_append_i16_neg_arr() {
    ...
    ba1.append_i16(-1_i16);
    ba1.append_i16(-2_i16);
    let expected: Array<u8> = test_array_16_neg();
    assert(ba1 == expected, 'values should match');
}
