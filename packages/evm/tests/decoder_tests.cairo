...
fn test_decode_array_of_strings_long_elements() {
    ...
    assert(*decoded.at(0) == 0x4, 'assertion failed');

    assert(*decoded.at(1) == 0x0, 'assertion failed');
    assert(*decoded.at(2) == 0x414C49, 'assertion failed'); // ALI
    assert(*decoded.at(3) == 0x3, 'assertion failed');
    assert(*decoded.at(4) == 0x0, 'assertion failed');
    assert(*decoded.at(5) == 0x56454C49, 'assertion failed'); // VELI
    assert(*decoded.at(6) == 0x4, 'assertion failed');
    assert(*decoded.at(7) == 0x1, 'assertion failed');
    assert(
        *decoded.at(8) == 0x4C4F4E47535452494E474C4F4E4745525448414E3132333132333132333132, 'match',
    ); // LONGSTRINGLONGERTHAN12312312312
    assert(
        *decoded.at(9) == 0x33313233415341534441534441444144, 'assertion failed',
    ); // 3123ASASDASDADAD
    assert(*decoded.at(10) == 16, 'assertion failed');
    assert(*decoded.at(11) == 0x0, 'assertion failed');
    assert(*decoded.at(12) == 0x73686F72746261636B, 'assertion failed'); // shortback
    assert(*decoded.at(13) == 0x9, 'assertion failed');
}
...
fn test_decode_array_of_strings() {
    ...
    let mut calldata = cd(data);
    let decoded = calldata.decode(array![EVMTypes::Array(array![EVMTypes::String].span())].span());
    assert(*decoded.at(0) == 0x2, 'assertion failed');
...
fn test_decode_array_tuple_with_multi_arrays() {
    ...
    // 33, [22,33,44,55,66]]]
    assert(*decoded.at(0) == 0x3, 'assertion failed');
    assert(*decoded.at(1) == 123, 'assertion failed');
    assert(*decoded.at(2) == 0x6, 'assertion failed');
    assert(*decoded.at(3) == 1, 'assertion failed');
    assert(*decoded.at(4) == 2, 'assertion failed');
    assert(*decoded.at(5) == 3, 'assertion failed');
    assert(*decoded.at(6) == 4, 'assertion failed');
    assert(*decoded.at(7) == 5, 'assertion failed');
    assert(*decoded.at(8) == 6, 'assertion failed');
    assert(*decoded.at(9) == 7676, 'assertion failed');
    assert(*decoded.at(10) == 0, 'assertion failed');
    assert(*decoded.at(11) == 0x1, 'assertion failed');
    assert(*decoded.at(12) == 347384, 'assertion failed');
    assert(*decoded.at(13) == 0, 'assertion failed');
    assert(*decoded.at(14) == 333, 'assertion failed');
    assert(*decoded.at(15) == 3, 'assertion failed');
    assert(*decoded.at(16) == 0, 'assertion failed');
    assert(*decoded.at(17) == 5, 'assertion failed');
    assert(*decoded.at(18) == 6, 'assertion failed');
    assert(*decoded.at(19) == 43, 'assertion failed');
    assert(*decoded.at(20) == 0, 'assertion failed');
    assert(*decoded.at(21) == 1, 'assertion failed');
    assert(*decoded.at(22) == 343455, 'assertion failed');
    assert(*decoded.at(23) == 0, 'assertion failed');
    assert(*decoded.at(24) == 444, 'assertion failed');
    assert(*decoded.at(25) == 3, 'assertion failed');
    assert(*decoded.at(26) == 10, 'assertion failed');
    assert(*decoded.at(27) == 10, 'assertion failed');
    assert(*decoded.at(28) == 10, 'assertion failed');
    assert(*decoded.at(29) == 33, 'assertion failed');
    assert(*decoded.at(30) == 0, 'assertion failed');
    assert(*decoded.at(31) == 5, 'assertion failed');
    assert(*decoded.at(32) == 22, 'assertion failed');
    assert(*decoded.at(33) == 0, 'assertion failed');
    assert(*decoded.at(34) == 33, 'assertion failed');
    assert(*decoded.at(35) == 0, 'assertion failed');
    assert(*decoded.at(36) == 44, 'assertion failed');
    assert(*decoded.at(37) == 0, 'assertion failed');
    assert(*decoded.at(38) == 55, 'assertion failed');
    assert(*decoded.at(39) == 0, 'assertion failed');
    assert(*decoded.at(40) == 66, 'assertion failed');
    assert(*decoded.at(41) == 0, 'assertion failed');
}
...
fn test_decode_array_tuple_statics_dynamic_on_middle() {
    ...
    assert(*decoded.at(0) == 0x2, 'assertion failed');
    assert(*decoded.at(1) == 123, 'assertion failed');
    assert(*decoded.at(2) == 0x3, 'assertion failed');
    assert(*decoded.at(3) == 5, 'assertion failed');
    assert(*decoded.at(4) == 6, 'assertion failed');
    assert(*decoded.at(5) == 7, 'assertion failed');
    assert(*decoded.at(6) == 9999, 'assertion failed');
    assert(*decoded.at(7) == 0, 'assertion failed');
    assert(*decoded.at(8) == 876, 'assertion failed');
    assert(*decoded.at(9) == 0x4, 'assertion failed');
    assert(*decoded.at(10) == 1, 'assertion failed');
    assert(*decoded.at(11) == 1, 'assertion failed');
    assert(*decoded.at(12) == 1, 'assertion failed');
    assert(*decoded.at(13) == 1, 'assertion failed');
    assert(*decoded.at(14) == 34334, 'assertion failed');
    assert(*decoded.at(15) == 0, 'assertion failed');
}
...
fn test_decode_tuple_array_static_first() {
    ...
    assert(*decoded.at(4) == 2, 'assertion failed');
    assert(*decoded.at(5) == 3, 'assertion failed');
    assert(*decoded.at(6) == 777, 'assertion failed');
    assert(*decoded.at(7) == 0x2, 'assertion failed');
    assert(*decoded.at(8) == 555, 'assertion failed');
    assert(*decoded.at(9) == 666, 'assertion failed');
}
...
fn test_decode_tuple_array() {
    ...
    assert(*decoded.at(0) == 0x2, 'assertion failed');
    assert(*decoded.at(1) == 0x3, 'assertion failed');
    assert(*decoded.at(2) == 1, 'assertion failed');
    assert(*decoded.at(3) == 2, 'assertion failed');
    assert(*decoded.at(4) == 4, 'assertion failed');
    assert(*decoded.at(5) == 123, 'assertion failed');
    assert(*decoded.at(6) == 0x2, 'assertion failed');
    assert(*decoded.at(7) == 555, 'assertion failed');
    assert(*decoded.at(8) == 666, 'assertion failed');
    assert(*decoded.at(9) == 777, 'assertion failed');
}
...
fn test_decode_array_of_array() {
    ...
    assert(*decoded.at(0) == 0x2, 'assertion failed');
    assert(*decoded.at(1) == 0x2, 'assertion failed');
    assert(*decoded.at(2) == 123, 'assertion failed');
    assert(*decoded.at(3) == 444, 'assertion failed');
    assert(*decoded.at(4) == 0x2, 'assertion failed');
    assert(*decoded.at(5) == 555, 'assertion failed');
    assert(*decoded.at(6) == 33, 'assertion failed');
}
...
fn test_decode_complex() {
    ...
    assert(*decoded.at(0) == 0x0, 'assertion failed');
    assert(*decoded.at(1) == 0x00bbffaa00, 'assertion failed');
    assert(*decoded.at(2) == 0x5, 'assertion failed'); // Bytes len
    assert(*decoded.at(3) == 0xffffffffffffffffffffffffffffffff, 'assertion failed'); // Uint256
    assert(*decoded.at(4) == 0xffffffffffffffffffffffffffff, 'assertion failed');
    assert(*decoded.at(5) == -48923, 'assertion failed'); // Int128
    assert(*decoded.at(6) == 0x2, 'assertion failed'); // Arr len
    assert(*decoded.at(7) == 111, 'assertion failed');
    assert(*decoded.at(8) == 222, 'assertion failed');
    assert(*decoded.at(9) == 777, 'assertion failed');
    assert(*decoded.at(10) == 888, 'assertion failed');
}
...
fn test_decode_array_of_struct() {
    ...
    assert(*decoded.at(0) == 0x3, 'assertion failed');
    assert(*decoded.at(1) == 0xb, 'assertion failed');
    assert(*decoded.at(2) == 0x16, 'assertion failed');
    assert(*decoded.at(3) == 0x1618, 'assertion failed');
    assert(*decoded.at(4) == 0x36f, 'assertion failed');
    assert(*decoded.at(5) == 0xe8d4a50fff, 'assertion failed');
    assert(*decoded.at(6) == 0x989680, 'assertion failed');
}
...
fn test_decode_array_uint128s() {
    ...
    assert(*decoded.at(0) == 0x3, 'assertion failed');
    assert(*decoded.at(1) == 0x1bd, 'assertion failed');
    assert(*decoded.at(2) == 0x16462, 'assertion failed');
    assert(*decoded.at(3) == 0x1a6e41e3, 'assertion failed');
}
...
fn test_decode_tuple_of_two() {
    ...
    assert(*decoded.at(0) == 0x7b, 'assertion failed');
    assert(*decoded.at(1) == 0x22b, 'assertion failed');
}
...
fn test_decode_tuple_of_two_uint256() {
    ...
    assert(*decoded.at(0) == 0x7b, 'assertion failed');
    assert(*decoded.at(1) == 0x0, 'assertion failed');
    assert(*decoded.at(2) == 0x22b, 'assertion failed');
    assert(*decoded.at(3) == 0x0, 'assertion failed');
}
...
fn test_decode_int128_neg() {
    ...
    assert(*decoded.at(0) == -128, 'assertion failed');
}
...
fn test_decode_multi_uint256() {
    ...
    assert(*decoded.at(0) == 0x20, 'assertion failed');
    assert(*decoded.at(1) == 0x0, 'assertion failed');
    assert(*decoded.at(2) == 0x44, 'assertion failed');
}
...
fn test_decode_multi_uint128() {
    ...
    assert(*decoded.at(0) == 0x20, 'assertion failed');
    assert(*decoded.at(1) == 0x44, 'assertion failed');
}
...
fn test_decode_bytes_one_full_slot() {
    ...
    assert(*decoded.at(0) == 0x1, 'assertion failed');
    assert(
        *decoded.at(1) == 0xffffffffffffffffffaaaaaaaaaaaaaaaaaaafffffffffffffffffafafafaf,
        'assertion failed',
    );
    assert(*decoded.at(2) == 0xfa, 'assertion failed');
    assert(*decoded.at(3) == 0x1, 'assertion failed');
}
...
fn test_decode_bytes_one_slot() {
    ...
    let decoded = calldata.decode(array![EVMTypes::Bytes].span());
    assert(*decoded.at(0) == 0x0, 'assertion failed');
    assert(*decoded.at(1) == 0xffaabb, 'assertion failed');
    assert(*decoded.at(2) == 0x3, 'assertion failed');
}
...
fn test_decode_bytes() {
    ...
    assert(*decoded.at(3) == 0x1a, 'assertion failed');
}
...
fn test_decode_bytes32_zeroes() {
    ...
    assert(*decoded.at(0) == 1, 'assertion failed');
    assert(
        *decoded.at(1) == 0x00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffff,
        'assertion failed',
    );
    assert(*decoded.at(2) == 0xff, 'assertion failed');
    assert(*decoded.at(3) == 1, 'assertion failed');
}
...
fn test_decode_bytes2() {
    ...
    assert(*decoded.at(0) == 1, 'assertion failed');
    assert(*decoded.at(1) == 0xff, 'assertion failed');
    assert(*decoded.at(2) == 0x22, 'assertion failed');
    assert(*decoded.at(3) == 1, 'assertion failed');
}
...
fn test_decode_bytes31() {
    ...
    assert(*decoded.at(2) == 0x0, 'assertion failed');
    assert(*decoded.at(3) == 1, 'assertion failed');
}
...
fn test_decode_int256_neg() {
    ...
    assert(*decoded.at(0) == 50, 'assertion failed');
    assert(*decoded.at(1) == 0, 'assertion failed');
    assert(*decoded.at(2) == 0x1, 'assertion failed');
}
...
fn test_decode_int256_pos() {
    ...
    let decoded = calldata.decode(array![EVMTypes::Int256].span());
    assert(*decoded.at(0) == 60, 'assertion failed');
    assert(*decoded.at(1) == 0, 'assertion failed');
    assert(*decoded.at(2) == 0x0, 'assertion failed');
}
...
fn test_decode_int256_zero() {
    ...
    let decoded = calldata.decode(array![EVMTypes::Int256].span());
    assert(*decoded.at(0) == 0, 'assertion failed');
    assert(*decoded.at(1) == 0, 'assertion failed');
    assert(*decoded.at(2) == 0x0, 'assertion failed');
}
...
fn test_decode_int8_neg() {
    ...
    assert(*decoded.at(0) == -5, 'assertion failed');
}
...
fn test_decode_address() {
    ...
    assert(*decoded.at(0) == 0x742d35Cc6634C0532925a3b844Bc454e4438f44e, 'assertion failed');
}
...
fn test_decode_transfer_from() {
    ...
    assert(*decoded.at(0) == selector.into(), 'assertion failed');
    assert(*decoded.at(1) == expected_from.into(), 'assertion failed');
    assert(*decoded.at(2) == expected_to.into(), 'assertion failed');
    assert(*decoded.at(3) == expected_amount.into(), 'assertion failed');
}
