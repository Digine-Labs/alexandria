...
fn test_decode_bytes32_zeroes() {
    ...
    //assert_eq!(*decoded.at(0), 0x1);
    assert_eq!(*decoded.at(0), 0x000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff);
    assert_eq!(*decoded.at(1), 0x00);
    //assert_eq!(*decoded.at(3), 0x1);
}
...
fn test_decode_bytes32() {
    ...
    let decoded = calldata.decode(array![EVMTypes::Bytes32].span());
    //assert_eq!(*decoded.at(0), 0x1);
    assert_eq!(*decoded.at(0), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff);
    assert_eq!(*decoded.at(1), 0xaa);
    //assert_eq!(*decoded.at(3), 0x1);
}
