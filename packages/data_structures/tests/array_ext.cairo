...
mod append_all {
    ...
    fn destination_empty() {
        ...
        assert(destination.len() == 3, 'empty dest len should be 3');
        assert(destination[0] == @21, 'empty dest[0] should be 21');
        assert(destination[1] == @42, 'empty dest[1] should be 42');
        assert(destination[2] == @84, 'empty dest[2] should be 84');
    }
    ...
    fn source_empty() {
        ...
        assert(destination.len() == 3, 'empty source len should be 3');
        assert(destination[0] == @21, 'empty source[0] should be 21');
        assert(destination[1] == @42, 'empty source[1] should be 42');
        assert(destination[2] == @84, 'empty source[2] should be 84');
    }
...
mod extend_from_span {
    ...
    fn empty_span() {
        ...
        assert(arr1 == array![1, 2, 3], 'empty span extend failed');
    }
    ...
    fn from_self() {
        ...
        assert(arr == array![1, 2, 3, 1, 2, 3], 'self extend failed');
    }
}
...
mod concat {
    ...
    fn empty_array_1() {
        ...
        let concatenated = arr1.concat(@arr2);
        assert(concatenated == arr2, 'empty arr1 concat failed');
    }
    ...
    fn empty_array_2() {
        ...
        let concatenated = arr1.concat(@arr2);
        assert(concatenated == arr1, 'empty arr2 concat failed');
    }
    ...
    fn both_empty() {
        ...
        assert(concatenated.is_empty(), 'both empty concat failed');
    }
}
...
mod pop_front_n {
    ...
    fn pop_zero() {
        ...
        assert(arr.pop_front().unwrap() == 21, 'arrays should match');
        assert(arr.pop_front().unwrap() == 42, 'arrays should match');
        assert(arr.pop_front().unwrap() == 84, 'arrays should match');
        assert(poped.is_empty(), 'poped should be empty');
    }
...
mod remove_front_n {
    ...
    fn remove_zero() {
        ...
        assert(arr.len() == 3, 'arr len should be 3');
        assert(arr[0] == @21, 'arrays should match');
        assert(arr[1] == @42, 'arrays should match');
        assert(arr[2] == @84, 'arrays should match');
    }
...
mod reversed {
    ...
    fn even() {
        ...
        assert(response.len() == 2, 'response len should be 2');
        assert(response == array![42, 21], 'even reversed mismatch');
    }
    ...
    fn size_1() {
        ...
        assert(response.len() == 1, 'response len should be 1');
        assert(response[0] == @21, 'arrays should match');
    }
...
mod occurrences {
    ...
    fn empty_array() {
        let arr: Array<felt252> = array![];
        assert(arr.occurrences(@21) == 0, 'arrays should match');
    }
}
...
mod min_position {
    ...
    fn of_u128() {
        let mut arr = get_u128_array();
        assert(arr.min_position().unwrap() == 0, 'arrays should match');
        assert(arr.len() == 3, 'arr len should be 3');
        arr.append(21_u128);
        assert(arr.min_position().unwrap() == 0, 'arrays should match');
        arr.append(20_u128);
        assert(arr.min_position().unwrap() == 4, 'arrays should match');
    }

    #[test]
    fn min_position_empty_array() {
        let arr: Array<u128> = array![];
        assert(arr.min_position().is_none() == true, 'arrays should match');
    }
...
mod max {
    ...
    fn max() {
        ...
        assert(arr.max().unwrap() == 84_u128, 'arrays should match');
        arr.append(85_u128);
        assert(arr.max().unwrap() == 85_u128, 'arrays should match');
    }
    #[test]
    fn max_empty_array() {
        let arr: Array<u128> = array![];
    ...
    fn max_one_item() {
        let arr = array![21_u128];
        assert(arr.max().unwrap() == 21_u128, 'arrays should match');
    }
...
mod max_position {
    ...
    fn max_position() {
        let mut arr = get_u128_array();
        assert(arr.max_position().unwrap() == 2, 'arrays should match');
        assert(arr.len() == 3, 'arr len should be 3');
        arr.append(84_u128);
        assert(arr.max_position().unwrap() == 2, 'arrays should match');
        arr.append(85_u128);
        assert(arr.max_position().unwrap() == 4, 'arrays should match');
    }

    #[test]
    fn max_position_empty_array() {
        let arr: Array<u128> = array![];
        assert(arr.max_position().is_none() == true, 'arrays should match');
    }

    #[test]
    fn max_position_one_item() {
        let arr = array![21_u128];
        assert(arr.max_position().unwrap() == 0, 'arrays should match');
        assert(arr.len() == 1, 'arr len should be 1');
    }
}
...
mod dedup {
    ...
    fn all_different() {
        ...
        assert(new_arr == arr, 'arrays should match');
    }
    ...
    fn one_match() {
        ...
        assert(new_arr == array![1, 2, 3, 4], 'dedup mismatch');
    }
    ...
    fn multiple_duplicates_same() {
        ...
        assert(new_arr.len() == 6, 'new_arr len should be 6');
        assert(*new_arr[0] == 1, 'new_arr[0] should be 1');
        assert(*new_arr[1] == 3, 'new_arr[1] should be 3');
        assert(*new_arr[2] == 4, 'new_arr[2] should be 4');
        assert(*new_arr[3] == 3, 'new_arr[3] should be 3');
        assert(*new_arr[4] == 4, 'new_arr[4] should be 4');
        assert(*new_arr[5] == 2, 'new_arr[5] should be 2');
    }
}
...
mod unique {
    ...
    fn one_duplicate() {
        ...
        assert(out_arr.len() == 4, 'out_arr len should be 4');
        assert(*out_arr[0] == 32_u128, 'out_arr[0] should be 32_u128');
        assert(*out_arr[1] == 256_u128, 'out_arr[1] should be 256_u128');
        assert(*out_arr[2] == 128_u128, 'out_arr[2] should be 128_u128');
        assert(*out_arr[3] == 1024_u128, 'out_arr[3] should be 1024_u128');
    }
    ...
    fn all_same() {
        ...
        assert(out_arr.len() == 1, 'out_arr len should be 1');
        assert(*out_arr[0] == 84_u128, 'out_arr[0] should be 84_u128');
    }
    ...
    fn empty() {
        ...
        assert(out_arr.is_empty(), 'out_arr should be empty');
    }
    ...
    fn duplicate_front() {
        ...
        assert(out_arr.len() == 4, 'out_arr len should be 4');
        assert(*out_arr[0] == 16_u128, 'out_arr[0] should be 16_u128');
        assert(*out_arr[1] == 128_u128, 'out_arr[1] should be 128_u128');
        assert(*out_arr[2] == 64_u128, 'out_arr[2] should be 64_u128');
        assert(*out_arr[3] == 32_u128, 'out_arr[3] should be 32_u128');
    }
    ...
    fn duplicate_middle() {
        ...
        assert(out_arr.len() == 4, 'out_arr len should be 4');
        assert(*out_arr[0] == 128_u128, 'out_arr[0] should be 128_u128');
        assert(*out_arr[1] == 256_u128, 'out_arr[1] should be 256_u128');
        assert(*out_arr[2] == 84_u128, 'out_arr[2] should be 84_u128');
        assert(*out_arr[3] == 1_u128, 'out_arr[3] should be 1_u128');
    }
    ...
    fn duplicate_back() {
        ...
        assert(out_arr.len() == 4, 'out_arr len should be 4');
        assert(*out_arr[0] == 32_u128, 'out_arr[0] should be 32_u128');
        assert(*out_arr[1] == 16_u128, 'out_arr[1] should be 16_u128');
        assert(*out_arr[2] == 64_u128, 'out_arr[2] should be 64_u128');
        assert(*out_arr[3] == 128_u128, 'out_arr[3] should be 128_u128');
    }
    ...
    fn without_duplicates() {
        ...
        assert(out_arr == arr, 'arrays should match');
    }
}
