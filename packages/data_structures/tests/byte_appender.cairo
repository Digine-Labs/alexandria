...
fn test_append_u16() {
    ...
    assert(ba == test_byte_array_8(), 'values should match');
}
...
fn test_append_u16_arr() {
    ...
    ba.append_u16(0x0506_u16);
    ba.append_u16(0x0708_u16);
    assert(ba == test_array_8(), 'values should match');
}
...
fn test_append_u64() {
    ...
    assert(ba == test_byte_array_16(), 'values should match');
}
...
fn test_append_u64_arr() {
    ...
    ba.append_u64(0x0102030405060708_u64);
    ba.append_u64(0x090a0b0c0d0e0f10_u64);
    assert(ba == test_array_16(), 'values should match');
}
...
fn test_append_u128() {
    ...
    assert(ba == test_byte_array_32(), 'values should match');
}
...
fn test_append_u128_arr() {
    ...
    ba.append_u128(0x0102030405060708090a0b0c0d0e0f10_u128);
    ba.append_u128(0x1112131415161718191a1b1c1d1e1f20_u128);
    assert(ba == test_array_32(), 'values should match');
}
...
fn test_append_u512() {
    ...
    assert(ba == test_byte_array_64(), 'values should match');
}
...
fn test_append_u512_arr() {
    ...
    let mut ba: Array<u8> = array![];
    ba.append_u512(test64);
    assert(ba == test_array_64(), 'values should match');
}
...
fn test_append_i8() {
    ...
    assert(ba1 == ba2, 'values should match');
}
...
fn test_append_i16() {
    ...
    assert(ba1 == test_byte_array_8(), 'values should match');
}
...
fn test_append_i16_arr() {
    ...
    ba1.append_i16(0x0506_i16);
    ba1.append_i16(0x0708_i16);
    assert(ba1 == test_array_8(), 'values should match');
}
...
fn test_append_i16_neg() {
    ...
    assert(ba1 == test_byte_array_16_neg(), 'values should match');
}
...
fn test_append_i16_neg_arr() {
    ...
    ba1.append_i16(-1_i16);
    ba1.append_i16(-2_i16);
    assert(ba1 == test_array_16_neg(), 'values should match');
}
...
fn test_append_i32_neg() {
    ...
    ba.append_i32(-1_i32);
    ba.append_i32(-2_i32);
    assert(ba == test_byte_array_16_neg(), 'values should match');
}
#[test]
fn test_append_i32_neg_arr() {
    ...
    ba.append_i32(-1_i32);
    ba.append_i32(-2_i32);
    assert(ba == test_array_16_neg(), 'values should match');
}
